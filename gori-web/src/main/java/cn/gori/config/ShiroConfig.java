package cn.gori.config;

import cn.gori.core.filter.PermissionFilter;
import cn.gori.core.filter.VerfityCodeFilter;
import cn.gori.core.shiro.LoginRealm;
import cn.gori.core.shiro.RetryLimitCredentialsMatcher;
...
//    }
    ...
    @Bean(name = "securityManager") // @Qualifier("blogLoginRealm") BlogRealm blogLoginRealm
