package cn.gori.core.BootListener;

import cn.gori.core.quartz.JobTask;
import cn.gori.entity.SysJob;
import cn.gori.service.ISysLogService;
import cn.gori.service.ISysRoleService;
...
public class DataSourceJobThread extends Thread {
    ...
    public void run() {
        try {
            ...
            job.setStatus(true);
            List<SysJob> jobList = new ArrayList<>();//jobService.selectListByPage(job);
            //开启任务
